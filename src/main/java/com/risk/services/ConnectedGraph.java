...
/**
 * Class containing the method to check
 * whether a map is a connected graph or not 
 * 
...
public class ConnectedGraph {
    ...
    /** 
     * Constructor for ConnectedGraph class, 
     * which sets initial data for the class.
     * Moreover, it sets a the countries 
     * visited value as false.
     * 
    ...
    /** 
     * Method for traversing the graph for
