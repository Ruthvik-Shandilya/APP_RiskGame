...
public class MapEditor {
    ...
    public void createNewMap() {
        ...
        //HashMap<Continent, HashSet<Country>> countriesincontinent = new HashMap<Continent, HashSet<Country>>();
...
//            System.out.println("Please enter name of continent and control value seperated by \",\"");
            for (int i = 0; i < numOfContinents; i++) {
                ...
                Continent checkContinent = new Continent(continentAndValue[0].trim(), Integer.parseInt(continentAndValue[1].trim()));
//                System.out.println(continentSet.contains(checkContinent));
                if ((continentSet.contains(checkContinent))) {
                    ...
                    continentSet.add(new Continent(continentAndValue[0], Integer.parseInt(continentAndValue[1].trim())));
                }
            }
        }
        catch(Exception e) {
        ...
        while(addmorecountries){
            ...
            if (continentSet.contains(bufferContinent)){
                ...
                for (int i = 0; i < numberofcountry; i++){
                    ...
                    System.out.println("Please enter name of country, x and y coordinate and neighboring countries seperated by ,");
            ...
            System.out.println("To add more countries press T, else press any key to exit, map will not be saved until complete");
